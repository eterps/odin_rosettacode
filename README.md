...
- [Determine if a string is numeric](https://rosettacode.org/wiki/Determine_if_a_string_is_numeric#Odin)
...
- [Higher-order functions](https://rosettacode.org/wiki/Higher-order_functions#Odin)
